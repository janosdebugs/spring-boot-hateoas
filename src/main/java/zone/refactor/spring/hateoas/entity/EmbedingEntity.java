...
public class EmbedingEntity<EMBEDTYPE extends zone.refactor.spring.hateoas.contract.Entity, LINKTYPE extends zone.refactor.spring.hateoas.contract.Entity>
    extends LinkedEntity<LINKTYPE>
    implements zone.refactor.spring.hateoas.contract.EmbedingEntity<EMBEDTYPE, LINKTYPE>
{
